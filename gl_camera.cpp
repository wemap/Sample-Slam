...
void gl_camera::setup(const math_vector_3f &scene_center, float scene_size) const
{
    ...
    gluPerspective(50, (float)vieww / (float)viewh, 1.00f, 10000.f); //neardist, fardist );
                                                                     //glOrtho(-500.0f, -500.0f, 500.0f,500.0f, neardist,fardist);
                                                                     //	glOrtho(-200.0f *ratio , 200.0f * ratio, -200.0f * ratio,200.0f * ratio, 0.01f, 1000.f );
